@props(['result', 'module' => 'recommendations'])

@php $product = $result->product; @endphp

<a href="{{ route('recommendations.click', ['product' => $product, 'module' => $module]) }}" class="product-card recommendation-card">
    ...
    <div class="product-card-body">
        ...
        <span class="recommendation-reason">{{ $result->reason() }}</span>
    </div>
</a>
